...
-(id) init {
    self = [super init];
    if (self) {
        _data = [[AppDelegate sharedAppDelegate] genres];
    }
    return self;
}
...
{
    [[NSNotificationCenter defaultCenter] postNotificationName:@"selectedGenre" object:self userInfo:[_data objectAtIndex:indexPath.row]];
}
@end