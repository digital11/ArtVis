...
-(id) init {
    self = [super init];
    if (self) {
        _data = [[AppDelegate sharedAppDelegate] artists];
    }
    return self;
}
...
{
    [[NSNotificationCenter defaultCenter] postNotificationName:@"selectedArtist" object:self userInfo:[_data objectAtIndex:indexPath.row]];
}
@end
